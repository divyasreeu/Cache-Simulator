...
void recursiveMatTrans (
	...
	size_t nn = n>>1;
        ...
        recursiveMatTrans ( global_n, nn, A, offset_row_A, offset_col_A, B, offset_row_B, offset_col_B );
        /* ... */
        recursiveMatTrans ( global_n, nn, A, offset_row_A, offset_col_A+nn, B, offset_row_B+nn, offset_col_B );
        /* ... */
        recursiveMatTrans ( global_n, nn, A, offset_row_A+nn, offset_col_A, B, offset_row_B, offset_col_B+nn );
        /* ... */
        recursiveMatTrans ( global_n, nn, A, offset_row_A+nn, offset_col_A+nn, B, offset_row_B+nn, offset_col_B+nn);
    }
}
